...
import useCloseCabinForm from "../hooks/useCloseCabinForm";
...
function Menus({ children}) {
  const [openId, setMenuOpen] = useState('')
  const [position, setPosition] = useState(null)
  const close = () => setMenuOpen('')
  const open = setMenuOpen
  return <MenuContext.Provider value={{openId, close, open, position, setPosition}}>
    {children}
...
function List({ children, id }) {
  ...
  const ref = useCloseCabinForm(close)
